...
def add_file():
    files = filedialog.askopenfilenames(title="이미지 파일을 선택하세요", \
                                        ...
                                        initialdir=r"C:\Users\user\Downloads") # 최초 C:/ 경로 보여줌
    # 파일 추가한 목록
    for file in files:
...
btn_add_file = Button(file_frame, width=12,text="파일추가", command=add_file)
btn_add_file.pack(side="left")

btn_del_file = Button(file_frame, width=12,text="선택 삭제", command=del_file)
